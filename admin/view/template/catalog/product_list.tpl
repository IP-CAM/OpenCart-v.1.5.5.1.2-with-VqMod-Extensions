<?php echo $header; ?>
    <div id="content">
        ...
        <div class="box">
            <div class="heading">
                <h1>
                    <img src="view/image/product.png" alt=""/> <?php echo $heading_title; ?>
                </h1>
                <div class="buttons">
                    <a onclick="location = '<?php echo $insert; ?>'" class="button"><?php echo $button_insert; ?></a><a onclick="$('#form').attr('action', '<?php echo $copy; ?>'); $('#form').submit();" class="button"><?php echo $button_copy; ?></a><a onclick="$('form').submit();" class="button"><?php echo $button_delete; ?></a>
                </div>
            </div>
            <div class="content">
                    ...
                    <table class="list">
                        ...
                        <tr id="head">
                            ...
                            <td class="left"><?php if ($sort == 'p.price') { ?>
                                ...
                                <?php } ?></td>
                            <td class="left"><?= $column_weight ?></td>
                        ...
                        <tr class="filter">
                            ...
                            <td>
                                <select name="filter_manufacturer_id" style="width: 100px;">
                                    <option value="*"></option>
                                    <option value="null">-</option>
                            ...
                            <td align="left"><input type="text" name="filter_weight" value="<?= $filter_weight ?>" size="8"/></td>
                            <td align="right">
                                <input type="text" name="filter_quantity" value="<?php echo $filter_quantity; ?>" size="8" style="text-align: right;"/>
                            </td>
                            ...
                            <td align="right">
                                <a onclick="clear_filter();" class="button"><?php echo $button_clear; ?></a>
                            </td>
                        </tr>
                        <?php if ($products) { ?>
