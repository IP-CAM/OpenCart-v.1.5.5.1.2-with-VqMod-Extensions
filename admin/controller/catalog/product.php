...
class ControllerCatalogProduct extends Controller {
    ...
    public function filter() {
        ...
        foreach ($results as $result) {
            ...
            $productAttribute = $this->model_catalog_product->getProductAttributeById($result['product_id'], PRODUCT_WEIGHT_ID);
            ...
            $json['products'][] = array(
                ...
                'action'       => $action,
                'weight'       => empty($productAttribute) ? '' : $productAttribute['value']
            );
        }
    ...
    private function getList() {
        ...
        $this->data['sort_weight'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.name' . $url, 'SSL');
