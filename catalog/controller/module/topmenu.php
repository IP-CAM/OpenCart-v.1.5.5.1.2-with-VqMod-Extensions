	...
	function getTopMenu ()	{
		...
		foreach ($top_cats as $top_cat)	{
			if ($top_cat['top']) {
				...
				$text_contacts = $this->language->get('text_contacts');
				
				#$category .= "\t<li>\n<a href=\"/index.php?route=product/special\">".$text_sale."</a>\n";
				$category .= "\t<li>\n<a href=\"/index.php?route=information/contact\">".$text_contacts."</a>\n\n</li>\n";
