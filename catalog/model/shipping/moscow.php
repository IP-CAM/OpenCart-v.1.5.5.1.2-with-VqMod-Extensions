		...
		if ($status) {
			$quote_data = array();
      		...
      		$quote_data['moscow'] = array(
        		...
        		'cost'         => $this->config->get('moscow_cost'),
        		'tax_class_id' => $this->config->get('moscow_tax_class_id'),
				'text'         => $this->currency->format($this->tax->calculate($this->config->get('moscow_cost'), $this->config->get('moscow_tax_class_id'), $this->config->get('config_tax')))
      		);
