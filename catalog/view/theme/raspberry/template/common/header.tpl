...
<!--            <li><a href="/security_policy">Политика Безопасности</a></li> -->
        ...
        <div id="info">
            <p class="">мы работаем:</p>
            <p>пн. - сб. с <strong>8.00</strong> до <strong>20.00</strong></p>
            <p>вс. - <strong>выходной</strong></p>
        </div>
        <div id="phones">
            <p class=""><strong>+375 29 XXX XX XX</strong></p>
            <p class=""><strong>+375 44 XXX XX XX</strong></p>
        </div>
        <div class="links">
            <ul class="ul-links">
