        ...
        <div class="product-info">
            ...
            <div class="right">
                ...
                <?php if ($review_status) { ?>
                    <div class="review">
                        <div>
                            <img src="catalog/view/theme/raspberry/image/stars-<?= intval($rating); ?>.png" alt="<?php echo $reviews; ?>"/>&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a>
                        </div>
                        <div class="share">
                    ...
                    <?php foreach ($products as $product) { ?>
                        <div>
                            ...
                            <?php if ($product['rating']) { ?>
                                <div class="rating">
                                    <img src="catalog/view/theme/raspberry/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>"/>
                                </div>
                            <?php } ?>
